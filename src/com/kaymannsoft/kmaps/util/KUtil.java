...
public class KUtil {
	...
	public static String KnodesToEquation(List<KNodes> solution, boolean min_or_max){
		
		return null;
	}
	
	public static List<KNodes> EquationToKNodes(String equation){
		
		return null;
	}
	
	public static String toMinTerms(String max_terms_equation){
		return null;
	}
	
	public static String toMaxTerms(String min_terms_equation){
		return null;
	}
}
